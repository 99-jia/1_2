...
// 缩略图的支持
void CMy12Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CMy12Doc::InitializeSearchContent()
{
...
void CMy12Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
